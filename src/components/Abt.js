    ...
    <div className="abt">
      ...
      <div className="work">
        <div className="work-item">
          <Link to="https://asb260199.github.io/textutilsapp/" target='_blank' rel="noreferrer"><img src="/textutils.png" alt="Project 1"/></Link>
        ...
        <div className="work-item">
          <Link to="https://asb260199.github.io/maptyapp/" target='_blank' rel="noreferrer"><img src="/mapty.png" alt="Project 2"/></Link>
        ...
        <div className="work-item">
          <Link to="https://asb260199.github.io/svelte-mortgage-calc/" target='_blank' rel="noreferrer"><img src="/mc.png" alt="Project 3"/></Link>
